...
> = {
  development: {
    ...
    iosBundleIdentifier: "dev.notsuhas.t3code.dev",
    androidPackage: "dev.notsuhas.t3code.dev",
  },
  preview: {
    appName: "T3 Code Preview",
    scheme: "t3code-preview",
    iosIcon: "./assets/icon-composer-prod.icon",
    iosBundleIdentifier: "dev.notsuhas.t3code.preview",
    androidPackage: "dev.notsuhas.t3code.preview",
  },
  production: {
    appName: "T3 Code",
    scheme: "t3code",
    iosIcon: "./assets/icon-composer-prod.icon",
    iosBundleIdentifier: "dev.notsuhas.t3code",
    androidPackage: "dev.notsuhas.t3code",
  },
};
