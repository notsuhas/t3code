...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.scheduledPromptsList]: AuthOrchestrationReadScope,
  [WS_METHODS.scheduledPromptsGet]: AuthOrchestrationReadScope,
  [WS_METHODS.scheduledPromptsCreate]: AuthOrchestrationOperateScope,
  [WS_METHODS.scheduledPromptsUpdate]: AuthOrchestrationOperateScope,
  [WS_METHODS.scheduledPromptsDelete]: AuthOrchestrationOperateScope,
  [WS_METHODS.scheduledPromptsSetEnabled]: AuthOrchestrationOperateScope,
  [WS_METHODS.scheduledPromptsRunNow]: AuthOrchestrationOperateScope,
  [WS_METHODS.scheduledPromptsRuns]: AuthOrchestrationReadScope,
  [WS_METHODS.scheduledPromptsSubscribe]: AuthOrchestrationReadScope,
